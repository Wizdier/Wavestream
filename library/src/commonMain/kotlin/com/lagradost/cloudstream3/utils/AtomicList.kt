...
/**
 * A thread-safe list backed by Kotlin's intrinsic `synchronized`.
 *
 * For iteration, wrap block in [withLock] to hold the lock for the duration:
 *   list.withLock { list.forEach { ... } }
 *
 * NOTE: Original CloudStream uses kotlinx.atomicfu but this implementation
 * uses plain synchronized for portability.
 */
