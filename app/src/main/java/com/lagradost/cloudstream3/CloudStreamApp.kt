...
class CloudStreamApp : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        ExceptionHandler(filesDir.resolve("last_error")) {
            // WaveStream: hardened restart path — never throw inside the crash handler
            try {
                ...
                // Restart is best-effort only; exiting cleanly is better than a
                // secondary crash loop inside the uncaught exception handler.
            }
        }.also {
            exceptionHandler = it
        ...
        // WaveStream: surface main-thread I/O and leaked resources during development
    ...
    // WaveStream: free image memory-cache aggressively when the OS signals pressure,
    // keeping the app resilient on low-RAM phones and Android TV boxes.
