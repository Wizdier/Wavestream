...
object InAppUpdater {
    private const val GITHUB_USER_NAME = "Wizdier"
    private const val GITHUB_REPO = "WaveStream"

    private const val PRERELEASE_PACKAGE_NAME = "com.wizdier.wavestream.prerelease"
